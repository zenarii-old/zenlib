...
pushd build
cl /nologo -Zi %error_flags% /DINTERNAL_BUILD /DUSE_OPENGL /DZEN3D /DZEN2D /I../zenlib/zencore ../sandbox.c /LD  /link user32.lib gdi32.lib opengl32.lib winmm.lib freetype.lib 
popd
REM ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
